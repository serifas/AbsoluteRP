        ...
        public void DrawListingCreation()
        {
            ...
            if(DrawInfoCreation == true)
            {
                ...
                if (ImGui.Button("Submit Listing"))
                {
                    ...
                    DataSender.SubmitListing(plugin.Configuration.username, plugin.Configuration.password, bannerBytes, ListingName, ListingDescription, ListingRules, inclusion,
